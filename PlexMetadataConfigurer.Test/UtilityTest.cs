...
namespace PlexMetadataConfigurer.Test
{
	...
	{
		[Theory]
		[InlineData("s02e01.Race.Moto3.mp4", "Episode 1", "Race Moto3")]
		[InlineData("s12e02.Qualifying.MotoGP.mp4", "Episode 2", "Qualifying MotoGP")]
		...
		[InlineData("s06e03.Race.MotoGP.mp4", "Episode 3", "Race MotoGP")]
		[InlineData("s06e01. WorldSSP300 - FP1 (593mb 1920x1080 47.546fps 2214kbps x265 deef).mkv", "Episode 1", "WorldSSP300 - FP1")]
		public void Utility_EpisodeTitle(string filename, string currentTitle, string expectedTitle)
		{
			var result = Utility.EpisodeTitle(currentTitle, filename);
